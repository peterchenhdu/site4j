                        ...
                        <section class="login_content">
                            ...
                            <#if enableVCode?exists && enableVCode>
                                <div class="form-group col-xs-6" style="padding-left: 0px;">
                                    <img alt="点击获取验证码" id="img-vCode" src="/admin/getVerificationCode"
                                         style="cursor:pointer;height: 34px;width: 180px;">
                                </div>
                                <div class="form-group col-xs-6">
                                    <span><input type="text" class="form-control" placeholder="验证码" id="vCode"
                                                 name="vCode"></span>
                                </div>
                            </#if>
                                ...
                                <div class="separator">
                                    ...
                                    <div>
                                        ...
                                        <p>Copyright © 2018 <a href="https://www.zhyd.me" target="_blank"
                                                               style="margin: 0">yadong.zhang</a>. All Rights Reserved.
                                        </p>
                                    </div>
                                </div>
                            </form>
