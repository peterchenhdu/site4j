    ...
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            ...
            <div class="x_panel">
                <div class="x_title">
                    <h2>发布文章
                        <small>HTML编辑器，使用 <a href="/admin/article/publishMd">Markdown编辑器</a></small>
                    </h2>
                    <div class="clearfix"></div>
                </div>
                <div class="x_content">
                    <form id="publishForm" class="form-horizontal form-label-left" novalidate>
                        ...
                        <div class="item form-group">
                        <label class="control-label col-md-1 col-sm-1 col-xs-12" for="originalAuthor">原作者 </label>
                        <div class="col-md-8 col-sm-8 col-xs-12">
                        ...
                        <div class="item form-group">
                        <label class="control-label col-md-1 col-sm-1 col-xs-12" for="originalLink">原文链接 </label>
                        <div class="col-md-8 col-sm-8 col-xs-12">
                        ...
                        <div class="item form-group">
                            <label class="control-label col-md-1 col-sm-1 col-xs-12" for="title">封面 <span
                                    class="required">*</span></label>
                        ...
                        <div class="item form-group">
                            <label class="control-label col-md-1 col-sm-1 col-xs-12" for="password">内容 <span
                                    class="required">*</span></label>
                        ...
                        <div class="item form-group">
                            <label class="control-label col-md-1 col-sm-1 col-xs-12" for="nickname"><i
                                    class="fa fa-refresh fa-fw fa-1x pointer" id="refressType"></i>分类 <span
                                    class="required">*</span></label>
                            <div class="col-md-11 col-sm-11 col-xs-12">
                        ...
                        <div class="item form-group">
                            <label class="control-label col-md-1 col-sm-1 col-xs-12" for="mobile"><i
                                    class="fa fa-refresh fa-fw fa-1x pointer" id="refressTag"></i>标签 <span
                                    class="required">*</span></label>
                            <div class="col-md-11 col-sm-11 col-xs-12">
                        ...
                        <div class="item form-group">
                            <label class="control-label col-md-1 col-sm-1 col-xs-12" for="mobile">状态 <span
                                    class="required">*</span></label>
                            <div class="col-md-11 col-sm-11 col-xs-12">
                        ...
                        <div class="item form-group">
                            <label class="control-label col-md-1 col-sm-1 col-xs-12" for="comment">开启评论 <span
                                    class="required">*</span></label>
                            <div class="col-md-11 col-sm-11 col-xs-12">
                        ...
                        <div class="custom-panel">
                            <h2 class="x_title custom-dropdown">其他录入项
                                <small> - 方便SEO收录</small>
                                <i class="pull-right fa fa-angle-double-up"></i></h2>
                            <div class="custom-container">
                                <div class="item form-group">
                                    <label class="control-label col-md-1 col-sm-1 col-xs-12" for="password">摘要 <span
                                            class="required">*</span></label>
                                ...
                                <div class="item form-group">
                                    <label class="control-label col-md-1 col-sm-1 col-xs-12" for="password">关键词 <span
                                            class="required">*</span></label>
                                    <div class="col-md-10 col-sm-10 col-xs-12">
                                        <textarea class="form-control col-md-7 col-xs-12" id="keywords" name="keywords"
                        ...
                        <div class="form-group">
                            <div class="col-md-10 col-sm-10 col-xs-12">
                                <button type="button" class="btn btn-success publishBtn"><i class="fa fa-pencil">
                                    发布文章</i></button>
