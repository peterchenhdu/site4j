            ...
            <div class="modal-body">
                <form id="addOrUpdateForm" class="form-horizontal form-label-left" novalidate>
                    ...
                    <div class="item form-group">
                        <label class="control-label col-md-2 col-sm-2 col-xs-12" for="refKey">KEY <span
                                class="required">*</span></label>
                        <div class="col-md-9 col-sm-9 col-xs-12">
                            <input type="text" class="form-control col-md-7 col-xs-12" name="refKey" id="refKey"
                                   required="required" placeholder="KEY"/>
                        </div>
                    </div>
                    <div class="item form-group">
                        <label class="control-label col-md-2 col-sm-2 col-xs-12" for="refValue">VALUE <span
                                class="required">*</span></label>
                        <div class="col-md-9 col-sm-9 col-xs-12">
                            <textarea class="form-control col-md-7 col-xs-12" rows="20" id="refValue" name="refValue"
                                      required="required" placeholder="VALUE"></textarea>
                        </div>
                    </div>
                </form>
            </div>
...
<script>
    ...
    $(function () {
        var options = {
            ...
            getInfoUrl: "/admin/template/get/{id}",
            updateUrl: "/admin/template/edit",
            removeUrl: "/admin/template/remove",
            createUrl: "/admin/template/add",
            columns: [
                {
                    checkbox: true
                }, {
