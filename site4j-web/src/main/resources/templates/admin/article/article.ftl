                ...
                <div class="x_content">
                    <div class="<#--table-responsive-->">
                        ...
                        <@shiro.hasPermission name="article:publish">
                            <a class="btn btn-default" title="发表文章" href="/admin/article/publish"> <i
    ...
    $(function () {
        ...
        $("#btn_update_status").click(function () {
            ...
            $.alert.confirm("确定批量发布？发布完成后用户可见", function () {
                $.ajax({
                    type: "post",
                    url: "/admin/article/batchPublish",
                    traditional: true,
                    data: {'ids': selectedId},
                    success: function (json) {
                        $.alert.ajaxSuccess(json);
        ...
        function push(ids) {
            $.alert.confirm("确定推送到百度站长平台？", function () {
                $.ajax({
                    type: "post",
                    url: "/admin/article/pushToBaidu/urls",
                    traditional: true,
                    data: {'ids': ids},
                    success: function (json) {
                        $.alert.ajaxSuccess(json);
