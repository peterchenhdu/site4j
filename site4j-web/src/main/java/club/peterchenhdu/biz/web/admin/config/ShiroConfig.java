 ...
 */
package club.peterchenhdu.biz.web.admin.config;


import club.peterchenhdu.biz.web.admin.config.redis.CustomRedisManager;
import club.peterchenhdu.biz.web.admin.shiro.ShiroService;
import club.peterchenhdu.biz.web.admin.shiro.credentials.RetryLimitCredentialsMatcher;
import club.peterchenhdu.biz.web.admin.shiro.realm.ShiroRealm;
import club.peterchenhdu.config.property.RedisProperties;
import club.peterchenhdu.config.property.ShiroProperties;
